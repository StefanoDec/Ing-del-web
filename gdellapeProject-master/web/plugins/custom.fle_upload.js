		  ...
		  jQuery.fn.customFile = function() {
		    ...
		    return this.each(function() {
		      ...
		      var $file = jQuery(this).addClass('custom-file-upload-hidden'), // the original file input
                ...
                if (jQuery(this).attr('data-btn-text') == "Sovrascrivi PDF"){
                  var  $button = jQuery('<span class="input-group-btn"><button type="button" class="file-upload-button btn radius-3 btn-danger"><i class="fa fa-upload"></i>' + jQuery(this).attr('data-btn-text') + '</button></span>');
                }else{
                  var  $button = jQuery('<span class="input-group-btn"><button type="button" class="file-upload-button btn radius-3 btn-primary"><i class="fa fa-upload"></i>' + jQuery(this).attr('data-btn-text') + '</button></span>');
                }
