                                                        ...
                                                        <tr>
                                                            <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                                <div>
                                                                    ...
                                                                    <h4 class="text-primary text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: #007bff; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Congratulazioni la tua convenzione &egrave; stata accettata!</h4>
                                                                    ...
                                                                    <h5 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 20px; line-height: 24px;" align="center">Ti inviamo questa email per notificarti l&apos;avvenuta accettazione della convenzione!</h5>
