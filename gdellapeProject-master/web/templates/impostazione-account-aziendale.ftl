            ...
            <form id="form_modifica" action="print.php" method="post" class="sky-form .validate boxed"
                ...
                <fieldset name="Ente-Azienda">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label class="input">
                                <input type="text" placeholder="Nome Ente / Azienda" name="NomeAzienda" value="Aveja srl" required>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label class="input">
                                <input type="text" placeholder="Indirizzo sede legale" name="SedeLegale" value="via pescara 1" required>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label class="input">
                                <input type="text" placeholder="Codice Fiscale o Partita IVA" name="PartitaIVA"  value="TDYCDJWDSCDEDFDSFSWEDF" required>
                            </label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 col-sm">
                            <div class="row">
                                <div class="col-6 col-sm-6">
                                    <label class="input">
                                        <input type="text" placeholder="Nome Rappresentante Aziendale" name="NomeRappresentante" value="mario"
                                               required>
                                    </label>
                                </div>
                                <div class="col-6 col-sm-6">
                                    <label class="input">
                                        <input type="text" placeholder="Cognome Rappresentante Aziendale"
                                               name="CognomeRappresentante" value="biondi" required>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm">
                            <div class="row">
                                <div class="col-6 col-sm-6">
                                    <label class="input">
                                        <input type="text" placeholder="Nome Responsabile" name="NomeResponsabile"  value="maria" required>
                                    </label>
                                </div>
                                <div class="col-6 col-sm-6">
                                    <label class="input">
                                        <input type="text" placeholder="Cognome Responsabile" name="CognomeResponsabile" value="bianca"
                                               required>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label class="input">
                                <input type="tel" placeholder="Numero di telefono" name="NumeroTelefonoResponsabile" value="333-1234567"
                                       required>
                            </label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg">
                            <label class="input">
                                <input type="email" placeholder="Email responsabile" name="EmailResponsabile" value="a@s.l" required>
                            </label>
                        </div>
                    </div>
                </fieldset>
