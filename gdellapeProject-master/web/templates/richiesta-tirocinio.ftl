                ...
                <fieldset>
                    ...
                    <div class="row mb-0 mr-10 ">
                        ...
                        <input class="input-modulo col col-sm pl-0" type="text" name="Nominativo"
                               value="${tirocinante.nome} ${tirocinante.cognome}" placeholder="Nome e Cognome del tirocinante" required>
                    </div>
                    ...
                    <div class="row mb-0 mr-10">
                        ...
                        <input class="input-modulo col-3 col-sm-3 col-md-6 col-lg-7 pl-0" type="text"
                               name="LuogoDiNnascita" value="${tirocinante.luogoDiNascita}" placeholder="Luogo di nascita" required>
                    ...
                    <div class="row mb-0 mr-10">
                        ...
                        <input class="input-modulo text-center col col-sm pl-0" type="text"
                               name="ProvinciaDiResidenza" value="${tirocinante.provinciaDiResidenza}" placeholder="XX" required>
