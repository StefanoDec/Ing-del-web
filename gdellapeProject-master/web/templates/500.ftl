    ...
    <section class="section-sm centrale border-top-section">
        <div class="container">
            ...
            <p class="fs-20 mb-10">Il server Web (che esegue il sito Web) ha riscontrato una condizione imprevista che
                gli ha impedito di soddisfare la richiesta da parte del client per l&apos;accesso all&apos;URL
                richiesto.
            </p>
            <p class="fs-20 mb-10">Questo errore pu&ograve; essere risolto solo mediante correzioni al software del
                server Web.
        ...
        <div class="container mt-50">
            ...
            <#if ServeletName?? && ServeletName?has_content>
            <div class="row">
