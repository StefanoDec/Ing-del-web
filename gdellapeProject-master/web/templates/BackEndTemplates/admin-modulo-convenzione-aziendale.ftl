...
<div class="container-fluid d-print-none">
    <div class="row d-print-none">
        ...
        <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3 d-print-none">
            ...
            <noscript>
                <div class="alert alert-danger mb-10 mt-10 d-print-none ">
            ...
            <section class="section-sm centrale border-top-section pl-20 pr-20">
                <div class="container">
                    <form id="modulo_tirocinante" action="/#" method="post" class="m-0">
                        <fieldset>
                            ...
                            <div class="row mb-0 mr-10 ">
                                <#if DangerEnte_Azienda??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        <button type="button" class="close" data-dismiss="alert">
                                            <span aria-hidden="true">&times;</span>
                                            <span class="sr-only">Chiudi</span>
                                        </button>
                                        <strong>Attenzione!</strong> ${DangerEnte_Azienda}
                                        </div>
                                    </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">Ente/Azienda </h4>
                                <input class="input-modulo col col-sm pl-0" type="text" <#if ValueOfEnte_Azienda??>  class="error" </#if>  name="Ente_Azienda"

                                      <#if ValueOfEnte_Azienda??> value="${ValueOfEnte_Azienda}" <#else> value="${azienda.ragioneSociale}" </#if>  placeholder="Nome Ente o Azienda">
                            </div>
                            ...
                            <div class="row mb-0 mr-10 ">
                                <#if DangerSedeLegale??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        ...
                                        <strong>Attenzione!</strong> ${DangerSedeLegale}
                                    </div>
                                </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">con sede legale in (indirizzo) </h4>
                                <input class="input-modulo col col-sm pl-0" type="text" <#if DangerSedeLegale??>  class="error" </#if> name="SedeLegale"
                                    <#if ValueOfSedeLegale??> value="${ValueOfSedeLegale}" <#else>  value="${azienda.indirizzoSedeLegale}" </#if> placeholder="indirizzo sede legale">
                            </div>

                            <div class="row mb-0 mr-10">
                                <#if DangerCodice_fiscale??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        <button type="button" class="close" data-dismiss="alert">
                                            <span aria-hidden="true">&times;</span>
                                            <span class="sr-only">Chiudi</span>
                                        </button>
                                        <strong>Attenzione!</strong> ${DangerCodice_fiscale}
                                    </div>
                                </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">Codice Fiscale (o Partita IVA) </h4>
                                <input class="input-modulo col col-sm pl-0" type="text" <#if DangerCodice_fiscale??>  class="error" </#if> name="Codice_fiscale"
                                       <#if ValueOfCodice_fiscale?? > value="${ValueOfCodice_fiscale}" <#else> value="${azienda.CFiscalePIva}"</#if>  placeholder="Codice fiscale">
                            </div>


                            <div class="row mb-0 mr-10 ">
                                <#if DangerRappresentante_legale_nome??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        <button type="button" class="close" data-dismiss="alert">
                                            <span aria-hidden="true">&times;</span>
                                            <span class="sr-only">Chiudi</span>
                                        </button>
                                        <strong>Attenzione!</strong> ${DangerRappresentante_legale_nome}
                                    </div>
                                </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">rappresentato da </h4>
                                <input class="input-modulo col col-sm pl-0" type="text" <#if DangerRappresentante_legale_nome??>  class="error" </#if> name="Rappresentante_legale_nome"
                                        <#if ValueOfRappresentante_legale_nome?? > value="${ValueOfRappresentante_legale_nome}" <#else>  value="${azienda.nomeLegaleRappresentante}" </#if> placeholder="Rapresentante legale">
                            </div>
                            <div class="row mb-0 mr-10 ">
                                <#if DangerRappresentante_legale_cognome??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        <button type="button" class="close" data-dismiss="alert">
                                            <span aria-hidden="true">&times;</span>
                                            <span class="sr-only">Chiudi</span>
                                        </button>
                                        <strong>Attenzione!</strong> ${DangerRappresentante_legale_cognome}
                                    </div>
                                </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">rappresentato da </h4>
                                <input class="input-modulo col col-sm pl-0" type="text"  <#if DangerRappresentante_legale_cognome??>  class="error" </#if> name="Rappresentante_legale_cognome"
                                        <#if ValueOfRappresentante_legale_cognome?? > value="${ValueOfRappresentante_legale_cognome}" <#else> value="${azienda.cognomeLegaleRappresentante}" </#if> placeholder="Rapresentante legale">
                            </div>
                            ...
                            <div class="row mb-0 mr-10 d-print-none">
                                <#if Dangerforo_competente??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        <button type="button" class="close" data-dismiss="alert">
                                            <span aria-hidden="true">&times;</span>
                                            <span class="sr-only">Chiudi</span>
                                        </button>
                                        <strong>Attenzione!</strong> ${Dangerforo_competente}
                                    </div>
                                </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">Ruolo del foro competente: </h4>
                                <input class="input-modulo col col-sm pl-0" type="text" <#if Dangerforo_competente??>  class="error" </#if> name="foro_competente"
                                        <#if ValueOfforo_competente?? > value="${ValueOfforo_competente}" <#else>  value="${azienda.foroControversia}" </#if> placeholder="ruolo del foro competente">
                            </div>
                            <p class="d-none d-print-block mr-10 fs-18 text-black">
                            ...
                            <div class="row mb-0 mr-10 d-print-none">
                                <#if Dangerdurata_gg??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        ...
                                        <strong>Attenzione!</strong> ${Dangerdurata_gg}
                                    </div>
                                </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">Durata convenzione: </h4>
                                <input class="input-modulo col col-sm pl-0" <#if Dangerdurata_gg??>  class="error" </#if>  type="text"  name="durata_gg"
                                        <#if ValueOfdurata_gg?? > value="${ValueOfdurata_gg}" <#else>  value="${azienda.durataConvenzione}" </#if> placeholder="N giorni">
                            </div>
                            ...
                            <div class="row mb-25 mr-10 mt-100 mb-200">
                                <#if DangerData_documento??>
                                    <div class="alert alert-danger mb-20 d-print-none">
                                        <button type="button" class="close" data-dismiss="alert">
                                            <span aria-hidden="true">&times;</span>
                                            <span class="sr-only">Chiudi</span>
                                        </button>
                                        <strong>Attenzione!</strong> ${DangerData_documento}
                                    </div>
                                </#if>
                                <h4 class="col-auto col-sm-auto pr-10 fs-20">L&apos;Aquila, il </h4>
                                <input class="input-modulo col-3 col-sm-3 pl-0 text-center"  <#if DangerData_documento??>  class="error" </#if> type="date" name="Data_documento"
                                        <#if ValueOfData_documento?? > value="${ValueOfData_documento?date?string("yyyy-MM-dd")}" <#else>  value="${azienda.dataConvenzione?date?string("yyyy-MM-dd")}"> </#if>
