            ...
            <div class="col-md-4 col-lg-3">
                <form action="/admin/modifica-admin" method="post">
                    <div class="form-group">
                        ...
                        <input  name="email"  <#if ValueOfemail?? > value="${ValueOfemail}"<#else> value="${user.email}" </#if> >
                    </div>
                    <div class="form-group">
                    ...
                    <input type="text" name="nome" <#if ValueOfnome?? > value="${ValueOfnome}"<#else> value="${admin.nome}" </#if> >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="cognome"  <#if ValueOfcognome?? > value="${ValueOfcognome}"<#else> value="${admin.cognome}" </#if>  >
                </div>
