            ...
            <form id="modulo_tirocinante" action="/account/moduli/convenzione" method="post" class="m-0">
                ...
                <fieldset>
                    ...
                    <h4 class="fw-700 text-justify mr-10 fs-22 mb-25 d-none d-print-block">CONVENZIONE PER LO
                        SVOLGIMENTO DI ATTIVITA&apos; DI TIROCINIO E DI ORIENTAMENTO (AI SENSI DELL&apos;ART.18
                        L.196/97,
                        DELL&apos;ART.1 DECRETO MINISTERO DEL LAVORO E PREVIDENZA SOCIALE N.142/98 E DELLA LEGGE 148 del
                        14/09/2011) PER STUDENTI E LAUREATI DEL DIPARTIMENTO DI INGEGNERIA E SCIENZE DELL&rsquo;INFORMAZIONE
                        E
                        MATEMATICA DELL&apos;UNIVERSITA&apos; DEGLI STUDI DELL&apos;AQUILA
                    </h4>
                    <h4 class="fw-400 text-center d-none d-print-block mb-25">tra:</h4>
                    <h4 class="fw-400 text-justify d-none d-print-block mb-25 p-3">L&rsquo;Universit&agrave; degli Studi
                        di L&rsquo;Aquila
                        &ndash;
                        Dipartimento di Ingegneria e Scienze dell&rsquo;Informazione e Matematica, con sede legale in
                        L&rsquo;Aquila, C.F./P.I. 01021630668, rappresentata per la stipula del presente atto
                        convenzionale,
                        dal Direttore del Dipartimento di Ingegneria e Scienze dell&rsquo;Informazione e Matematica
                        Prof.
                        Guido Proietti, nato a Roma il 13/06/1966,domiciliato per il presente atto presso la sede legale
                        del l&rsquo;Universit&agrave;, e autorizzato e delegato alla stipula della presente Convenzione
                        dal Rettore
                    ...
                    <div class="row mb-0 mr-10 ">
                        ...
                        <input class="input-modulo col col-sm pl-0" type="text" name="Ente_Azienda"
                               value="<#if azienda.ragioneSociale??>${azienda.ragioneSociale}</#if>"
                               placeholder="Nome Ente o Azienda">
                    </div>
                    ...
                    <div class="row mb-0 mr-10 ">
                        ...
                        <input class="input-modulo col col-sm pl-0" type="text" name="SedeLegale"
                               value="<#if azienda.indirizzoSedeLegale??>${azienda.indirizzoSedeLegale}</#if>"
                    ...
                    <div class="row mb-0 mr-10">
                        ...
                        <input class="input-modulo col col-sm pl-0" type="text" name="Codice_Fiscale"
                               value="<#if azienda.CFiscalePIva??>${azienda.CFiscalePIva}</#if>"
                    ...
                    <div class="row mb-0 mr-10 ">
                        ...
                        <input class="input-modulo col col-sm pl-0" type="text" name="Rappresentante_Legale_Nome"
                               value="<#if azienda.nomeLegaleRappresentante??>${azienda.nomeLegaleRappresentante}</#if>"
                               placeholder="Rapresentante legale">
                        <input class="input-modulo col col-sm pl-0" type="text" name="Rappresentante_Legale_Cognome"
                               value="<#if azienda.cognomeLegaleRappresentante??>${azienda.cognomeLegaleRappresentante}</#if>"
                               placeholder="Rapresentante legale">
                    </div>
                    ...
                    <ul class="d-none d-print-block mr-10">
                        <li><p>
                                che i tirocini formativi e di orientamento sono ora disciplinati dall&apos;articolo 18
                                della
                                legge 24 giugno 1997 n.196, dal suo regolamento di attuazione emanato con Decreto 25
                                marzo
                                1998, n.142 e dalla legge 148 del 14/09/2011;</p>
                        </li>
                        <li><p>
                                che il Dipartimento di Ingegneria e Scienze dell&rsquo;Informazione e Matematica intende
                                attuare
                                progetti diretti al raggiungimento delle finalit&agrave; indicate dall&apos;art.18 L. 24
                                giugno 1997
                                n.196 e dall&apos;art.1 del suddetto decreto 25 marzo 1998 n. 142, che promuovono
                                tirocini
                        ...
                        <li><p>
                                ...
                                processi
                                formativi i soggetti richiamati dall&apos;art.18, comma 1, lett. a) della legge 24
                                giugno 1997
                                n.196, tra cui le Universit&agrave;, possono promuovere tirocini formativi e di
                                orientamento presso
                                datori di lavori pubblici e privati a beneficio di coloro che abbiano gi&agrave; assolto
                                l&apos;obbligo
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>1.1 </b>
                        L&apos;Ente/l&apos;Azienda si impegna ad accogliere presso le proprie strutture soggetti in
                        tirocinio di
                        formazione ed orientamento, ai sensi dell&apos;art. 18 della legge 24 giugno 1997 n. 196 e della
                        legge 148 del 14/09/2011, in numero non superiore a quanto disposto dall&apos;articolo 1, comma
                        3,
                        ...
                        Dipartimento di Ingegneria e Scienze dell&rsquo;Informazione e Matematica dell&apos;Universit&agrave;
                        degli Studi
                        di L&apos;Aquila, a condizione che il tirocinio inizi non oltre i 12 mesi successivi al
                        conseguimento
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>1.2 </b>
                        Ai fini dello svolgimento del tirocinio l&rsquo; Ente/l&apos;Azienda mette a disposizione del
                        Dipartimento
                        di Ingegneria e Scienze dell&rsquo;Informazione e Matematica dell&apos;Universit&agrave; le
                        proprie strutture.
                        L&apos;accesso alle strutture sar&agrave; guidato dal personale dell&rsquo;Ente/Azienda
                        ospitante, con compiti di
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>2.1 </b>
                        Il tirocinio formativo e di orientamento, ai sensi dell&apos;art. 18, comma 1 lett. d) della
                        legge
                        196 del 1997 non costituisce rapporto di lavoro e non d&agrave; luogo ad alcuna ipotesi di
                        attivit&agrave;
                        occupazionale. L&apos;Ente/l&apos;Azienda non ha alcun obbligo di assunzione al termine del
                        periodo di
                        tirocinio.
                    </p>
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>2.2 </b>
                        Durante lo svolgimento del tirocinio, l&apos;attivit&agrave; di formazione ed orientamento
                        &egrave; seguita e
                        verificata da un tutore designato dal Dipartimento di Ingegneria e Scienze dell&rsquo;Informazione
                        e
                        Matematica dell&apos;Universit&agrave; in veste di responsabile didattico - organizzativo (il
                        cui nominativo
                        risulter&agrave; dal Progetto formativo e di orientamento dei singoli stagisti) e da un
                        responsabile
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>2.3 </b>
                        Per ciascun tirocinante da inserirsi nell&apos;Ente/Azienda ospitante verr&agrave; predisposto
                        tra le parti
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>2.4 </b>
                        L&apos;avvio operativo per lo svolgimento dei singoli tirocini avverr&agrave; con scambio di
                        lettera di
                        conferma tra l&apos;Ente/l&apos;Azienda ospitante ed il tirocinante, con allegata copia del
                        relativo
                        Progetto di cui al n.2.3 che precede, sottoscritto dall&rsquo;Ente/l&apos;Azienda, dal
                        Dipartimento di
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>2.5 </b>
                        E&apos; consentita, con l&apos;approvazione del responsabile aziendale, la partecipazione del
                        tirocinante
                        ad attivit&agrave; aziendali fuori sede. In tal caso le spese di viaggio e di soggiorno o
                        eventuali
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>3.1 </b>
                        Come previsto dalla normativa vigente la durata massima dei tirocini potr&agrave; essere di 6
                        mesi nel
                        ...
                        tirocinante.
                        La durata stessa potr&agrave; essere prorogata, previo accordo tra le parti, entro i limiti
                        massimi
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>3.2 </b>
                        &Egrave; consentita, per giustificati motivi, la richiesta da parte del tirocinante di una
                        interruzione
                        temporanea dello stage, comunque non superiore a n.&deg; 2 settimane consecutive, previa
                        comunicazione all&rsquo;Ente/Azienda ospitante, ferma restando la durata complessiva del
                        tirocinio
                    ...
                    <ul class="d-none d-print-block mr-10">
                        ...
                        <li><p>cooperare al conseguimento degli obiettivi che lo riguardano, osservando gli orari
                                concordati
                                e rispettando l&apos;ambiente di lavoro e le esigenze di coordinamento dell&apos;attivit&agrave;
                                di ricerca
                                dell&apos;azienda</p></li>
                        <li><p>rispettare le norme in materia di igiene, sicurezza e salute sui luoghi di lavoro con
                                particolare riferimento all&rsquo;art. 20 del D.Lgs. n. 81/2008 &ldquo;Obblighi del
                                lavoratore&rdquo;;</p>
                        </li>
                        <li><p>mantenere la necessaria riservatezza per quanto attiene ai dati, informazioni e/o
                                conoscenze
                                in merito ad attivit&agrave; di ricerca dell&rsquo;Ente/l&apos;Azienda (ed ai relativi
                        ...
                        <li><p>inviare al Direttore del Dipartimento di Ingegneria e Scienze dell’Informazione e
                                Matematica
                                dell&apos;Universit&agrave; degli Studi dell&apos;Aquila, mensilmente ed entro il giorno
                                8 del mese
                                successivo a
                                quello cui si riferiscono, le presenze effettive in tirocinio presso l&rsquo;Ente/Azienda,
                                rilevate
                                dalla scheda che sar&agrave; consegnata all&apos;atto della compilazione del
                                Progetto.</p></li>
                    </ul>
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>3.4 </b>
                        ...
                        dell&rsquo; Ente/l&apos;Azienda essa potr&agrave;, previa informazione al tutore incaricato dal
                        Dipartimento di
                        Ingegneria e Scienze dell&rsquo;Informazione e Matematica, sospendere o interrompere lo
                        svolgimento
                        del tirocinio.
                    </p>
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black mb-10"><b>3.5 </b>
                        La realizzazione del tirocinio non comporta per l&rsquo; Ente/l&apos;Azienda e per il
                        Dipartimento di
                        Ingegneria e Scienze dell&rsquo;Informazione e Matematica dell&apos;Universit&agrave; degli
                        Studi dell&apos;Aquila
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black">
                        L&rsquo;Ente/l&apos;Azienda potr&agrave; peraltro erogare eventuali somme a titolo di rimborso
                        spese (da prevedere
                        nel progetto formativo), secondo le norme e le procedure interne all&rsquo; Ente/l&apos;Azienda
                        stesso,
                        ...
                        modifiche alla natura dei rapporti oggetto della presente Convenzione, o facolt&agrave; o
                        diritti
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black mb-10"><b>3.6 </b>
                        L&rsquo;Azienda/Ente ospitante si impegna a garantire che il tirocinio si svolga presso
                        strutture
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black">
                        L&rsquo;Azienda/Ente ospitante si impegna inoltre ad assolvere a tutti gli obblighi indicati dal
                        D.
                        lgs 81/2008 con particolare riguardo al Titolo I, Capo III, sez. IV &ldquo;Formazione,
                        informazione e
                        addestramento&rdquo;, sezione V &ldquo;Sorveglianza sanitaria&rdquo; per i casi eventualmente
                        previsti (presenza
                        di rischi specifici), e al Titolo III, Capo II &ldquo;Uso dei dispositivi di protezione
                        individuali&rdquo;.
                    </p>
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>4.1 </b>
                        L&apos;Universit&agrave; degli Studi di L&apos;Aquila si impegna ad assicurare i tirocinanti
                        contro gli infortuni
                        sul lavoro presso l&apos;INAIL, nonch&eacute; per la responsabilit&agrave; civile presso
                        compagnie assicurative
                        operanti nel settore ed indicate nel progetto formativo. L&apos;assicurazione dovr&agrave;
                        coprire anche le
                        attivit&agrave; svolte nell&apos;ambito del tirocinio fuori sede ai sensi del punto 2.5. Gli
                        estremi
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black"><b>4.2 </b>
                        In caso di infortunio durante lo svolgimento del tirocinio, l&rsquo;Ente/l&apos;Azienda si
                        impegna a
                        segnalare l&apos;evento, entro i tempi previsti dalla normativa vigente, agli istituti
                        assicurativi
                        (quali risultanti dal Progetto formativo e di orientamento e facendo riferimento al numero della
                        polizza sottoscritta dall&apos;Universit&agrave; degli Studi di L&apos;Aquila) ed all&apos;Universit&agrave;
                        stessa.
                    </p>
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black mb-10">
                        Il Dipartimento di Ingegneria e Scienze dell&rsquo;Informazione e Matematica dell&apos;Universit&agrave;
                        degli
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black mb-10">
                        L&rsquo; Ente/l&apos;Azienda per delega che l&apos;Universit&agrave; degli Studi di L&apos;Aquila
                        le conferisce con la
                        presente, provveder&agrave; a far pervenire alle Rappresentanze Sindacali dei Lavoratori copia
                        della
                    ...
                    <p class="d-none d-print-block mr-10 fs-18 text-black mb-10">
                        ...
                        stage/tirocinio al centro per l&apos;impiego competente entro le ore 24 del giorno antecedente,
                        solo
                    ...
                    <div class="row mb-0 mr-10 d-print-none">
                        ...
                        <input class="input-modulo col col-sm pl-0" type="text" name="Foro_Competente"
                               value="<#if azienda.foroControversia??>${azienda.foroControversia}</#if>"
                               placeholder="ruolo del foro competente">
                    </div>
                    <p class="d-none d-print-block mr-10 fs-18 text-black">
                        L&rsquo;imposta di bollo &egrave; a carico del Soggetto ospitante, salvo accordi specifici tra
                        le parti e
                    ...
                    <div class="row mb-0 mr-10 d-print-none">
                        ...
                        <input class="input-modulo col col-sm pl-0" type="text" name="Durata_GG"
                               value="<#if azienda.durataConvenzione??>${azienda.durataConvenzione}</#if>"
                    ...
                    <div class="row mb-25 mr-10 mt-100">
                        ...
                        <input class="input-modulo col-3 col-sm-3 pl-0 text-center" type="date" name="Data_Documento"
                               value="${data?date?iso_utc}">
                    </div>

                    <div class="container d-none d-print-block p-0 mt-200">
