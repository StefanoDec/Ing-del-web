...
public class AdminGestioneAccountController extends BackEndAziendaController{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        TemplateController.process("BackEndTemplates/gestione-account.ftl", datamodel, response, getServletContext());
    }
