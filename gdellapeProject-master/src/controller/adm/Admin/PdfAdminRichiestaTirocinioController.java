...
public class PdfAdminRichiestaTirocinioController extends baseController {
        ...
        if(request.getAttribute("tipo").equals(1)) {
            if (request.getParameter("id") != null) {
                ...
                try {
                    ...
                    datamodel.put("titoloDescrittivo", "Modulo Richiesta Tirocinio");
                    datamodel.put("titolo", "Richiesta Tirocinio");
