...
public class CaricaModuloSegreteriaTirocinioController extends baseController {
    ...
    private void caricaConvezione(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException
    {
        ...
        try{
            datamodel.put("url","/admin/Gestione-tirocinio");
...
//                String path=pdf.uploadPDF(request,"."+File.separator+"PDF"+File.separator+"Segreteria"+File.separator+tr.getOffertaTirocinio().toString()+File.separator+tr.getTirocinante().toString(),PDF);
