...
public class GestioneDettagliTirocinio extends baseController {
    ...
    private void fillDatamodel(HttpServletRequest request) throws DaoException {
    ...
    private void caricaVotazioneSuAzienda(HttpServletRequest request) throws DaoException {
        Integer idTirocinio = Integer.parseInt(request.getParameter("idTirocinio"));
        Azienda azienda = ritornaAzienda(ritornaOffertaTirocinio(idTirocinio));
    ...
    private void caricaVotazioneSuTirocinio(HttpServletRequest request) throws DaoException {
        Integer idTirocinio = Integer.parseInt(request.getParameter("idTirocinio"));
        Tirocinio tirocinio = ritornaTirocinio(idTirocinio);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            fillDatamodel(request);
            caricaVotazioneSuTirocinio(request);
            caricaVotazioneSuAzienda(request);
